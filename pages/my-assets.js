...
export default function MyAssets() {
  ...
  async function loadNFTs() {
    ...
    const items = await Promise.all(data.map(async i => {
      ...
      let item = {
        ...
        name: meta.data.name + " #" + i.tokenId.toNumber(),
  ...
  async function sellNft() {
    // console.log(nftmarketaddress, nftaddress, window.sellTokenId, newPrice)
    ...
    if(newPrice === null || newPrice === undefined || newPrice === ""){
      ...
      const transaction = await contract.putItemToResell( nftaddress, window.sellTokenId, price,{ value: listingPrice } )
  ...
  return (
    <div className="contents">
      <div className="flex justify-center main-container" style={{marginTop:'50px'}}>
        <div className="p-4 main-container">
          ...
          {
            error ?
            <div className="float-right w-64 sticky right-0">
              <div className="border border-red-400 text-red-700 px-4 py-3 rounded absolute" style={ {backgroundColor:'#fff'} } role="alert">
                <strong className="font-bold">Please enter a valid price!</strong>
